            ...
            <div class="school-card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Data Nascimento:</strong> {{ $teacher->birth_date->format('d/m/Y') }}</p>
                        <p><strong>Idade:</strong> {{ $teacher->birth_date->diffInYears(now()) }} anos</p>
                    </div>
                    <div class="col-md-6">
                        <h6>Contactos</h6>
                        ...
                        <p><strong>Data Contratação:</strong> {{ $teacher->hire_date->format('d/m/Y') }}</p>
        ...
        <div class="school-card mb-4">
            ...
            <div class="school-card-body">
                <div class="text-center">
                    <div class="user-avatar mx-auto mb-3" style="width: 80px; height: 80px; font-size: 24px; background: linear-gradient(135deg, var(--accent), #0097A7);">
                ...
                <div class="d-grid gap-2">
                    ...
                    @can('edit_teachers')
                        <form action="{{ route('teachers.toggle-status', $teacher->id) }}" method="POST" class="d-grid">
                            @csrf
                            <button type="submit" class="btn btn-{{ $teacher->status == 'active' ? 'warning' : 'success' }}">
