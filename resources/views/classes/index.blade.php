                    ...
                    <table class="table table-school">
                        ...
                        <tbody>
                            @forelse($classes as $class)
                                @php
                                    // Use preloaded count from controller to avoid N+1 queries
                                    $activeStudentsCount = $class->active_students_count ?? 0;
                    ...
                    <div class="school-card-body border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                Mostrando {{ $classes->firstItem() }} a {{ $classes->lastItem() }} de {{ $classes->total() }}
                                registros
                            </div>
                            {{ $classes->links() }}
                        </div>
