    ...
    <div class="col-md-4">
        ...
        <div class="school-card mb-4">
            ...
            <div class="school-card-body text-center">
                ...
                <div class="mb-3">
                    <span class="badge bg-{{ $student->status === 'active' ? 'success' : ($student->status === 'inactive' ? 'danger' : 'warning') }} fs-6">
    ...
    <div class="col-md-8">
        ...
        <div class="school-card mb-4">
            ...
            <div class="school-card-body">
                ...
                <div class="text-center">
                    <a href="{{ route('students.attendance', $student) }}" class="btn btn-school btn-primary-school btn-sm">
        ...
        <div class="school-card mb-4">
            ...
            <div class="school-card-body">
                ...
                <div class="text-center">
                    <a href="{{ route('students.payments', $student) }}" class="btn btn-school btn-primary-school btn-sm">
