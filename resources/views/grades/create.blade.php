                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="grade" id="grade" class="form-control" min="0" max="20"
                                        step="0.1" value="{{ old('grade') }}" placeholder="0.0 - 20.0" required>
                                    @error('grade')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select name="assessment_type" id="assessment_type" class="form-select" required>
                                        ...
                                        <option value="ACS1" {{ old('assessment_type') == 'ACS1' ? 'selected' : '' }}>ACS 1
                                        </option>
                                        <option value="ACS2" {{ old('assessment_type') == 'ACS2' ? 'selected' : '' }}>ACS 2
                                        </option>
                                        <option value="ACS3" {{ old('assessment_type') == 'ACS3' ? 'selected' : '' }}>ACS 3
                                        </option>
                                        <option value="ACP" {{ old('assessment_type') == 'ACP' ? 'selected' : '' }}>ACP
                                        </option>
                                        <option value="ACF" {{ old('assessment_type') == 'ACF' ? 'selected' : '' }}>ACF
                                        </option>
                                        <option value="behavioral" {{ old('assessment_type') == 'behavioral' ? 'selected' : '' }}>Comportamento/Desenv.</option>
                                        <option value="test" {{ old('assessment_type') == 'test' ? 'selected' : '' }}>Teste
                                        </option>
                                        <option value="exam" {{ old('assessment_type') == 'exam' ? 'selected' : '' }}>Exame
                                            Final</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_recorded" id="date_recorded" class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="comments" id="comments" class="form-control" rows="2"
                                        placeholder="Observações sobre a nota...">{{ old('comments') }}</textarea>
                                    @error('comments')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
