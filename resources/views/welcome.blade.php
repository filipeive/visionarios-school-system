...
<body class="font-sans antialiased text-gray-800">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <div
                        class="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-3 shadow-lg">
                        VS
                    </div>
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="#about"
                        class="text-blue-800 font-medium hover:text-blue-600 transition duration-300">Sobre</a>
                    <a href="#admissions"
                        class="text-gray-600 hover:text-blue-800 transition duration-300">Admissões</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 py-4 border-t border-gray-200">
                <div class="flex flex-col space-y-4">
                    ...
                    <a href="#admissions" class="text-gray-600 hover:text-blue-800 transition">Admissões</a>
    ...
    <section class="hero-image min-h-screen flex items-center justify-center text-white relative overflow-hidden">
        ...
        <div class="absolute inset-0">
            ...
            <div class="absolute top-3/4 right-1/4 w-48 h-48 bg-yellow-500/10 rounded-full animate-float"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <p class="text-gray-600 mb-8 text-lg leading-relaxed">
                        Na Visionaries School, estamos comprometidos em proporcionar uma experiência educacional
                        transformadora que capacita os estudantes a se tornarem pensadores críticos, solucionadores
                        criativos de problemas e líderes compassivos do amanhã.
                    </p>
    ...
    <section id="admissions" class="py-20 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Pre-Enrollment -->
                <div class="bg-blue-50 p-8 rounded-2xl border-2 border-blue-100 text-center">
                    <div
                        class="w-16 h-16 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <i class="fas fa-file-signature text-2xl"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Pré-Inscrição Online</h3>
                    <p class="text-gray-600 mb-6">Poupe tempo e inicie o processo de matrícula do seu filho de forma
                        totalmente digital.</p>
                    <a href="{{ route('public.pre-enrollment') }}"
                ...
                <!-- Material Lists -->
                <div class="bg-yellow-50 p-8 rounded-2xl border-2 border-yellow-100 text-center">
                    <div
                        class="w-16 h-16 bg-yellow-500 text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <i class="fas fa-list-ul text-2xl"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Lista de Materiais</h3>
                    <p class="text-gray-600 mb-6">Consulte a lista completa de materiais necessários para cada classe e
                        nível de ensino.</p>
                    <a href="{{ route('public.material-lists') }}"
                        class="inline-block bg-yellow-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-yellow-600 transition duration-300">
                        Ver Listas
                    </a>
                </div>

                <!-- Announcements -->
                <div class="bg-indigo-50 p-8 rounded-2xl border-2 border-indigo-100 text-center">
                    <div
                        class="w-16 h-16 bg-indigo-600 text-white rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <i class="fas fa-bullhorn text-2xl"></i>
                    </div>
                    <h3 class="text-2xl font-bold text-blue-800 mb-4">Comunicados</h3>
                    <p class="text-gray-600 mb-6">Fique por dentro das datas importantes, taxas oficiais e avisos da
                        secretaria.</p>
                    <a href="{{ route('public.announcements') }}"
                        class="inline-block bg-indigo-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-indigo-700 transition duration-300">
                        Ler Avisos
                    </a>
                </div>
            </div>
    ...
    <section id="features" class="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto text-lg">
                    Nosso sistema abrangente de gestão escolar oferece todas as ferramentas necessárias para uma
                    administração eficiente e aprendizagem aprimorada
                </p>
                <div class="w-24 h-1 bg-gradient-to-r from-blue-600 to-yellow-500 mx-auto mt-6 rounded-full"></div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @foreach($features as $feature)
                    <div class="feature-card bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl">
                        <div
                            class="w-16 h-16 bg-{{ $feature['color'] }}-100 rounded-2xl flex items-center justify-center text-{{ $feature['color'] }}-800 mb-6 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    <div class="flex items-center mb-6">
                        <div
                            class="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-blue-800 font-bold text-xl mr-4">
                            VS
                        </div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        @foreach($socials as $social)
                            <a href="#"
                                class="w-10 h-10 bg-blue-700 rounded-lg flex items-center justify-center text-white hover:bg-yellow-500 transition duration-300">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        @foreach($quickLinks as $name => $link)
                            <li>
                                <a href="{{ $link }}"
                                    class="text-blue-200 hover:text-white transition duration-300 hover:translate-x-2 inline-block">
                                    {{ $name }}
                                </a>
                            </li>
                        @endforeach
